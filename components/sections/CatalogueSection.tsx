  ...
  return (
    <section className="catalogue-section" id="products">
      <div className="section-heading">
        ...
        <p>
          Search by part numbers, manufacturers, models and
          descriptions.
        </p>
      </div>
      ...
      <div className="result-bar">
        <p>
          <b>{filteredProducts.length}</b> matching item records
        </p>
      ...
      {!filteredProducts.length && (
        <div className="empty-state">
          ...
          <p>
            Send the manufacturer, part number, datasheet or a
            clear product photo.
          </p>

          <button onClick={onOpenCustomRfq}>
            Start a custom RFQ
          </button>
        </div>
      )}
